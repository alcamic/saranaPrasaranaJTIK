 ...
 * @author AlCaMiC
 */
public class PeminjamanKelas extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    private DefaultTableModel model;
    public PeminjamanKelas() {
        initComponents();
        scaleImage();
        scaleImage1();
        loadKelas();
    ...
    public void loadKelas(){
        ...
        String sql = "SELECT nama_kelas from datakelas WHERE status = 'Tidak Terpakai';";
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Nama Peminjam (Kelas/Organisasi)");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, 20));
        ...
        jPanel4.add(pinjamKelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, -1, -1));
        jPanel4.add(namaPeminjam, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 260, -1));

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 520, 240));
    ...
    try {
        ...
        updateStmt.close();
        System.out.println("Kelas successfully updated!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeminjamanKelas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
